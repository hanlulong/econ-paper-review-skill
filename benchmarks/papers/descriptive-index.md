# A Monthly Local Price Pressure Index
...
Shops submit prices voluntarily. The number of reporting shops ranges from 18 to 36 by town and month. Missing item prices are dropped, and the remaining expenditure shares are renormalized to sum to one. We do not report response rates because the number of eligible shops is unavailable.
